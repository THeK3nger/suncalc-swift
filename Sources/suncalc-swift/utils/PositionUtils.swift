...
class PositionUtils {
    ...
    @available(swift, deprecated: 1.0, message: "will soon become unavailable. Use getRightAscension instead.")
    class func getRightAscensionL(l:Double, b:Double) -> Double {
        return PositionUtils.getRightAscension(l: l, b: b)
    }
    
    @available(swift, deprecated: 1.0, message: "will soon become unavailable. Use getDeclination instead.")
    class func getDeclinationL(l:Double, b:Double) -> Double {
        return PositionUtils.getDeclination(l: l, b: b)
    }
    
    @available(swift, deprecated: 1.0, message: "will soon become unavailable. Use getAzimuth instead.")
    class func getAzimuthH(h:Double, phi:Double, dec:Double) -> Double {
        return PositionUtils.getAzimuth(h: h, phi: phi, dec: dec)
    }
    
    @available(swift, deprecated: 1.0, message: "will soon become unavailable. Use getAltitude instead.")
    class func getAltitudeH(h:Double, phi:Double, dec:Double) -> Double {
        return PositionUtils.getAltitude(h: h, phi: phi, dec: dec)
    }
    
    @available(swift, deprecated: 1.0, message: "will soon become unavailable. Use getSiderealTime instead.")
